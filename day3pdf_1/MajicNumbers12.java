//to count the no of 1s in the majical infinite series 1 2 2 1 1 2 1 2 2 1 2 2 1 1 2 1 1 2 2......
package day3_pdf1;
import java.util.*;
...
public static void main(String[] args) {
	...
	int[] n=new int[size];
	n[0]=1;n[1]=2;n[2]=2;// to start with majical no count
	int count=0,zero=3,start=3;
	for(int i=2;i<size;i++) {//to iterate each elem in array n
	...
	}System.out.print("The majical seies is: ");
